...
2. Locate the following line:
   ```markdown
   📊 [[View Full Interactive Dashboard](https://github.com/ghasi87)](https://htmlpreview.github.io/?https://github.com/Rayan-Config/C-Sub/blob/main/assets/performance_report.html)
   ```
